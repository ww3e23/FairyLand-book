...
| [光術師](/classes/light-mage/)／[闇術師](/classes/dark-mage/) | 組隊、輔助、暗法仍是很多人會養的功能角 | 光暗本來就不是純輸出路線；人少時會補、會暗更吃香 | 想被需要、想跟家族一起玩 |
...
3. **工作還是有人買** — 產物長一樣。重點是：**等級練高成本很高**；太低等的，自己用不到、別人也不一定收。先做自己會用、或市場確實在收的等級，再考慮往上砸
4. **商人／大老闆** — 可以當打手，不是一定要做買賣。見 [商人](/classes/merchant/)、[大老闆](/classes/tycoon/)
5. **日常魔幣** — 吉恩村戰鬥達人（官方：20 級以上、每日 2 次）。一般祝福卡每次額外 **5 魔幣**（一天 10）。開了超級祝福卡會變成每次 **10 魔幣**（一天 20）。活動可能再加倍
